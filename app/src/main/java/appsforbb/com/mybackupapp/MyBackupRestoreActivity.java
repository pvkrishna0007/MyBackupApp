 ...
 */
public class MyBackupRestoreActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDataFile = new File(getFilesDir(), MyBackupRestoreActivity.DATA_FILE_NAME);
    ...
    void populateUI() {
        ...
        synchronized (MyBackupRestoreActivity.sDataLock) {
